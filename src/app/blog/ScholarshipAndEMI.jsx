  ...
  return (
    <main className="max-w-6xl mx-auto px-5 py-12 font-sans text-gray-800 leading-relaxed">
      <Helmet>
        ...
        <meta property="og:image" content="https://www.unifost.com/images/blogs/scholarship-emi.jpg" />
        ...
        <meta name="twitter:image" content="https://www.unifost.com/images/blogs/scholarship-emi.jpg" />
      </Helmet>
        ...
        <aside className="w-full md:w-[40%] flex flex-col gap-6">
          ...
          <section>
            ...
            <div className="grid gap-4">
              ...
              >
                <img src="/b4.png" alt="LPU Online Review" className="h-32 w-full object-cover" />
                <div className="p-3">
              ...
              <a
                ...
                className="block bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden"
              >
                <img src="/b1.png" alt="MBA Online vs Distance" className="h-32 w-full object-cover" />
                <div className="p-3">

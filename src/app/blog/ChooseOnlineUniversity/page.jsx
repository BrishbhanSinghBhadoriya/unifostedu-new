...
const ChooseOnlineUniversity = () => {
  return (
    <main className="max-w-6xl mx-auto px-4 py-12 text-gray-800 leading-relaxed">
        ...
        <meta property="og:image" content="https://www.unifost.com/images/blogs/choose-online-university.webp" />
        ...
        <meta name="twitter:image" content="https://www.unifost.com/images/blogs/choose-online-university.webp" />

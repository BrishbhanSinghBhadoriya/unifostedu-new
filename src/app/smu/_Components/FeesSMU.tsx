...
const FeesSMU: React.FC<IntroducationProps> = ({ setOpenModal }) => {
  ...
  const Buttons = (slug: string) => (
    <div className="flex gap-3 mt-4 flex-wrap">
      ...
      <button
        ...
        className="bg-[#f26722] hover:bg-orange-600 text-white font-semibold px-3 py-2 sm:px-4 sm:py-2 lg:px-6 lg:py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg text-sm sm:text-base"
      >
      ...
      {/* More Info Button */}
      <button
        onClick={() => router.push(`/smu/${slug}`)}
        className="border border-[#f26722] text-[#f26722] font-semibold px-3 py-2 sm:px-4 sm:py-2 lg:px-6 lg:py-3 rounded-full hover:bg-orange-50 transition-all duration-300 text-sm sm:text-base"
      >
        More Info
      </button>
    </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-800 mb-4">
            Sikkim Manipal University Online Courses, Fees & Programs
          </h2>
        ...
        <div className="mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              {Buttons("Courses_pages/bcom-online")}
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              {Buttons("Courses_pages/ba-online")}
            </div>
        ...
        <div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              {Buttons("Courses_pages/mba-online")}
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              {Buttons("Courses_pages/mca-online")}
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              {Buttons("Courses_pages/mcom-online")}
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              {Buttons("Courses_pages/ma-online")}
            </div>

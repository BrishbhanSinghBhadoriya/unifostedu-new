...
export const metadata = {
  title: "SMU Online BCom 2026-27 | Bachelor of Commerce | Fees ₹75,000 | NAAC A+ | Sikkim Manipal University",
  description:
  ...
  keywords: [
    ...
    "SMU BCom fees",
    "SMU BCom degree 2026",
    "online BCom SMU 2026",
    "online BCom 2026 India",
    "SMU BCom admission 2026-27",
    "SMU BCom syllabus",
  ...
  twitter: {
    ...
    title: "SMU Online BCom 2026-27 | Bachelor of Commerce | NAAC A+ | ₹75,000 Fee",
    description:

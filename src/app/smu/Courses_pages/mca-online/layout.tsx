...
export const metadata = {
  ...
  keywords: [
    ...
    "NAAC A+ online MCA",
    "best online MCA India",
    "online MCA working professionals",
    "SMU MCA Java Python",
    "online MCA cloud computing",
    "online MCA machine learning",
    "distance MCA degree India",
    "UGC DEB MCA degree",
    "SMU MCA placement",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327468/mca1_ilvxyr.webp",
        width: 1200,
        height: 630,
        alt: "SMU Online MCA — Master of Computer Applications from Sikkim Manipal University",
      },
    ],
    locale: "en_IN",
    type: "website",
  ...
  alternates: {
    canonical: "https://unifostedu.com/smu/mca",
  },
  twitter: {
...
export default function SmuMCALayout({ children }: ChildrenProps) {
  return <>{children}</>;
}
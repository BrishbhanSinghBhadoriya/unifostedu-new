...
const SMU = () => {
  ...
  const ugCourses = [
    ...
    },
    {
      ...
      eligibility: "10+2 or equivalent",
      fees: "₹90,000",
      specialization: "Business Analytics & Fintech , Entrepreneurship , Operations & Supply Chain Management, Banking & Insurance ",
     
      image: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327036/ba_hakemz.webp",
       university: "Sikkim Manipal University",
      universityShort: "SMU",
      alt: "Bachelor of Business Administration (BBA) in SMU Online",
      },
    {

  ...
  return (
    <>
      ...
      <div className="font-manrope overflow-x-hidden">
        ...
        <HeroSection openmodel={openModal} setOpenModal={setOpenModal}/>
       ...
       <Accreditations openmodel={openModal} setOpenModal={setOpenModal} />

        {/* Introduction to MAHE University Online */}
       <Interoducation openmodel={openModal} setOpenModal={setOpenModal} />
      ...
      <AboutUs openmodel={openModal} setOpenModal={setOpenModal} />

        {/* Why Choose MAHE University Online */}
       <WhyChoose openmodel={openModal} setOpenModal={setOpenModal} />


        {/* Campus Tour Section */}
       <CampusTour openmodel={openModal} setOpenModal={setOpenModal} />


        {/* Enhanced Courses Section */}
       <ExploreCourses   ugCourses={ugCourses}
  pgCourses={pgCourses} openmodel={openModal} setOpenModal={setOpenModal}/>
        ...
        <AdvantageHighlights openmodel={openModal} setOpenModal={setOpenModal} />
        ...
        {/* Why Choose Section */}
       <Fees openmodel={openModal} setOpenModal={setOpenModal} />

      <AdmissionProcess openmodel={openModal} setOpenModal={setOpenModal} />

         

        {/* Certificate Section */}
        <Certification openmodel={openModal} setOpenModal={setOpenModal} />
       ...
       <PlacementPartnerRecords openmodel={openModal} setOpenModal={setOpenModal} />


        {/* Premium Testimonials / Student Reviews */}
       <StudentReviews testimonials={testimonials} openModal={openModal} setOpenModal={setOpenModal}/>
...
/>
      ...
      <HiringPartners openmodel={openModal} setOpenModal={setOpenModal} />

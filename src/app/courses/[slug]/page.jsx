  ...
  'mba-online': {
    ...
    universities: [
      ...
      },
      {
        ...
        specializations: ['Human Resource Management, Finance, Marketing, Operations Management, Business Analytics, Digital Marketing, Data Science, Information Technology, International Business, Banking & Financial Services, Hospital & Healthcare Management, Logistics & Supply Chain Management'],
        fee: ' ₹2,00,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        specializations: ["Oil and Gas Management,Power Management,Logistics and Supply Chain Management, Business Analytics,Infrastructure Management,International Business,Marketing Management,Human Resource Management,Operations Management,Financial Management ,Digital Business"],
      ...
      // },
      {
        ...
        specializations: [ "Dual Specialization(Marketing, Finance, HR systems, Operations and Supply Chain Management, Healthcare Management)",
],
        fee: '₹1,10,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        specializations: ['Marketing', 'Digital ','Human Resource','Business Analytics','Finance Management','International Business','Information Technology ','Logistics and Supply Chain Management'],
        fee: '₹1,40,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Quality Education', 'Industry Projects', 'Career Support']
  ...
  'bba-online': {
    ...
    universities: [
      ...
      },
      {
        ...
        rating: 4.3,
        image: '/images/upes.png',
        specializations: ["Operations Management, Financial Management, Human Resource Management, Marketing Management, BBA in Digital Business, BBA in Logistics and Supply Chain, BBA in International Business",],
        fee: '₹1,50,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Industry Focused', 'Expert Faculty', 'Placement Support']
      ...
      },
      {
        ...
        rating: 4.4,
        image: '/images/jain.png',
        specializations: ["Online Bachelor of Business Administration, Digital Marketing, Healthcare Management, Data Science and Analytics"],
        fee: '₹1,50,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Modern Curriculum', 'Industry Projects', 'Career Support']
      },
      {
        ...
        rating: 4.3,
        image: '/images/dypatil.png',
        specializations: ["IT & System Management, International Business Management, Retail Management, Banking, Financial Services and Insurance Management, Shipping & Logistics Management, Marketing Management, Human Resource Management (HRM), Finance Management, E-commerce Management"],
        fee: '₹1,45,400',
        duration: '3 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        fee: '(63,000/- + 27,000/-) = ₹90,000/- [ ₹27,000/-(Only to be paid after Placement)]',
        duration: '3 Years',
        accreditation: 'UGC Approved',
    ...
    universities: [
      {
        ...
        rating: 4.6,
        image: '/images/manipal.png',
        specializations: ['Data Science and Analytics, Cyber Security, Cloud Computing'],
        fee: '₹99,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Industry Projects', 'Career Services', 'Flexible Learning']
      ...
      },
      {
        ...
        rating: 4.3,
        image: '/images/jain.png',
        specializations: ["Computer Science and IT, Data Science and Analytics, Cyber Security, Artificial Intelligence, Cloud Computing"],
        fee: '₹80K - ₹1.6L',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Modern Curriculum', 'Industry Projects', 'Career Services']
      },
      {
        ...
        rating: 4.1,
        image: '/images/shoolini.jpg',
        specializations: ['Machine Learning, Data Science, Cyber Secruity and Artificial Intelligence'],
        fee: '(63,000/- + 27,000/-) = ₹90,000/- [ ₹27,000/-(Only to be paid after Placement)]',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Research Focus', 'Industry Connect', 'Career Guidance']
      ...
      },
      {
        ...
        rating: 4.2,
        image: '/images/upes.png',
        specializations: ["New Age Technology, Cloud Computing & Cyber Security, Data Analytics"],
        fee: '₹1,50,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
  ...
  'bcom-online': {
    ...
    universities: [
      ...
      },
      {
        ...
        rating: 4.1,
        image: '/images/shoolini.jpg',
        specializations: ['Accounting, Finance and Taxation'],
        fee: '₹75,000/-',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Research Focus', 'Industry Connect', 'Career Guidance']
    ...
    universities: [
      {
        ...
        rating: 4.3,
        image: '/images/sharda.png',
        specializations: ['Hons', 'Political Science'],
        fee: '₹1,05,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        rating: 4.4,
        image: '/images/amity.png',
        specializations: ['Native languages(Malayalam, Tamil, Hindi, kananda, Telugu)'],
        fee: '₹99,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        rating: 4.1,
        image: '/images/vgu1.png',
        specializations: "'Economics + Public Policy + Computer Applications' 'Public Policy + English' 'English + History + Political Science' 'Computer Applications + Public Policy/IR' 'Political Science + International Relations + Public Policy' '51+ COMBINATIONS AVAILABLE'",
        fee: '₹72,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Quality Education', 'Research Projects', 'Career Support']
      ...
      
      {
        ...
        rating: 4.1,
        image: '/images/smu-uni.jpg',
        specializations: ['English, Sociology, Political Science'],
        fee: '₹75,000',
        duration: '3 Years',
        accreditation: 'UGC Approved',
        features: ['Expert Faculty', 'Career Services', 'Flexible Learning']
  ...
  'mcom-online': {
    ...
    universities: [
      ...
      },
      {
        ...
        rating: 4.3,
        image: '/images/sharda.png',
        specializations: ['Public Accounting'],
        fee: '₹50,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Experienced Faculty', 'Industry Exposure', 'Counselling']
  ...
  'ma-online': {
    ...
    universities: [
      ...
      },
      {
        ...
        rating: 4.3,
        image: '/images/lpu.png',
        specializations: ['English', 'History', 'Sociology', 'Political Science'],
        fee: '₹80,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Affordable Education', 'Research Focus', 'Career Guidance']
      },
      {
        ...
        rating: 4.2,
        image: '/images/chandigarh.jpg',
        specializations: [' Psychology', 'English', 'Economics'],
        fee: '₹1,00,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Quality Education', 'Research Projects', 'Career Support']
      },
      {
        ...
        rating: 4.3,
        image: '/images/jain.png',
        specializations: ['Jainology in Comparative Religion and Philosophy', 'English', 'Economics', 'Public Policy'],
        fee: '₹1,90,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        rating: 4.4,
        image: '/images/opjindal.png',
        specializations: ['Teching English to speakers of others', 'Public Policy', ],
        fee: '₹90K - ₹1.6L',
        duration: '2 Years',
        accreditation: 'UGC Approved',
      ...
      },
      {
        ...
        rating: 4.1,
        image: '/images/shoolini.jpg',
        specializations: ['Englishv Literachere'],
        fee: '₹42,000/-',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Research Focus', 'Industry Connect', 'Career Guidance']
    ...
    universities: [
      {
        ...
        rating: 4.6,
        image: '/images/amity.png',
        specializations: ['Jaournalism and Mass Communication'],
        fee: '₹1,70,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Live Classes', 'Industry Mentors', 'Portfolio Guidance']
      ...
      },
      {
        ...
        rating: 4.2,
        image: '/images/vgu1.png',
        specializations: ['Journalism and Mass Communication', ],
        fee: '₹72,000',
        duration: '2 Years',
        accreditation: 'UGC Approved',
        features: ['Quality Education', 'Industry Projects', 'Career Support']
    ...
    'msc-online': {
      ...
      universities: [
        ...
        // },
        {
          ...
          rating: 4.3,
          image: '/images/chandigarh.jpg',
          specializations: [ 'Data Science', 'Mathematics', ],
          fee: '₹1,00,000 - ₹1,46,668',
          duration: '2 Years',
          accreditation: 'UGC Approved',
          features: ['Quality Education', 'Research Projects', 'Career Support']
        },

...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://unifostedu.com/bookdemo",
    siteName: "UNIFOST",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Book Demo | Free Counseling Session | UNIFOST",
    description:
      "Book a free demo session with our education experts. Get personalized guidance for your online degree journey.",
...
export default function BookDemoLayout({ children }: ChildrenProps) {
  return (
    <div>
      {children}

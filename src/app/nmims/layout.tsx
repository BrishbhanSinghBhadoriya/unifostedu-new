...
export const metadata = {
  ...
  keywords: [
    ...
    "nmims online mcom",
    "nmims online ma",
    "nmims online courses list",
    "nmims online ugc approved degrees",
    "nmims online admission 2025",
    "nmims online january batch",
    "nmims online apply now",
    "nmims online eligibility",

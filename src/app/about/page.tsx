      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[ 
              { icon: <FaUser className="text-3xl text-white" />, number: "5,000+", text: "Students Guided" },
              { icon: <FaBuildingColumns className="text-3xl text-white" />, number: "25+", text: "Partner Institutions" },
              { icon: <FaLocationDot  className="text-3xl text-white" />, number: "50+", text: "Cities Covered" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ 
              ...
              { image: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327031/acard6-2_h6wqrc.webp", title: "Home Demo Sessions", desc: "Experience learning firsthand with trial sessions conducted at your convenience before committing to any program.", icon: <FaHouse className="text-2xl" /> },
              { image: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327030/acard3_rkw0cv.webp", title: "Certified Programs", desc: "Access to industry-recognized certifications and courses that enhance your employability and skills.", icon: <FaAward className="text-2xl" /> },
              ...
              { image: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327031/acard5_t1gih4.webp", title: "University Admissions", desc: "Expert assistance in selecting and applying to traditional universities with high placement records.", icon: <FaBuildingColumns className="text-2xl" /> },
              { image: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327031/acard6_qhf7ia.webp", title: "Skill Development", desc: "Specialized courses and workshops to bridge the gap between academic learning and industry requirements.", icon: <FaScrewdriverWrench className="text-2xl" /> }
            ].map((service, index) => (

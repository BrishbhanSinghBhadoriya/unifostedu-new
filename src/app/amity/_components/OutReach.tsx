        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-700 text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
              Whether you're searching for an "online MBA degree program near me" or want a flexible Amity University
              Online degree program while working in metro cities, our digital campus supports learners across India
              with weekend live sessions, city-specific mentoring, and dedicated counsellors.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {cityHighlights.map((highlight, index) => (
              ...
              >
                <h3 className="text-xl font-semibold text-gray-900 mb-3">{highlight.city}</h3>
                <p className="text-gray-700 text-sm md:text-base leading-relaxed">{highlight.focus}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 bg-blue-900 text-white rounded-2xl p-6 md:p-8">
            ...
            <p className="text-sm md:text-base leading-relaxed text-blue-100">
              ...
              right Amity University Online programme, understand the latest fees 2026 structure, and align your online

...
const HiringPartners: React.FC<HiringPartnersProps> = ({ setOpenModal }) => {
  return (
    <section id="HiringPartners" className="py-16 bg-gray-50" aria-labelledby="hiring-heading">
      <div className="max-w-7xl mx-auto px-6">

        {/* Heading */}
        <div className="text-center mb-12">
          <h2 id="hiring-heading" className="text-3xl font-bold text-gray-900 mb-4 font-[Poppins]">
            Our Hiring Partners
          </h2>
        ...
        {/* Logos grid — CSS hover instead of framer-motion */}
        <ul
        ...
        <div className="w-full flex justify-center mt-6">
          <Button
            ...
            size="lg"
            aria-label="Enquire now about Amity University online placement support"

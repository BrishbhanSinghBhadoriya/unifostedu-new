...
import { BookOpen, Briefcase, X, Globe, Laptop2, Users } from 'lucide-react';
...
const Highlights = ({ setOpenModal, openModal }: { setOpenModal: (state: OpenModalState) => void; openModal: OpenModalState }) => {
  return (

      ...
      <section id="PlacementRecord" className="py-16 bg-gradient-to-br from-blue-50 via-white to-purple-50 relative font-[Inter]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Placement Record</h2>
            <div className="w-24 h-1 bg-yellow-500 mx-auto mb-6 rounded-full" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {[
              ...
              <div
                key={index}
                className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-center hover:shadow-lg transition-shadow"
              >
          ...
          {/* Closing Paragraph */}
          <p className="text-center text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Amity Online not only focuses on academic excellence but also on <strong>employability</strong>, helping
            students transform their online degrees into successful careers through continuous industry collaborations

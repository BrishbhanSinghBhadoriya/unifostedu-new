...
const Upes = () => {
  ...
  const faqData = [
    {
      ...
      answer: "Eligibility varies depending on the course. Generally, candidates must have completed 10+2 for UG programs and a bachelor's degree from a recognized university for PG programs.",
    },
    {
      question: "Is UPES Online recognized by UGC?",
      answer: "Yes, UPES Online offers UGC-entitled programs approved under the UGC (Online Education) Regulations, ensuring equal recognition as regular degrees.",
    },
    {
      question: "Can I study while working a full-time job?",
      answer: "Absolutely. UPES Online programs are designed for working professionals, offering flexible learning schedules and self-paced study options.",
    },
    {
      question: "How can UniFost Counsellors help in the admission process?",
      answer: "UniFost Counsellors provide complete guidance — from course selection and document verification to form submission and LMS onboarding after admission.",
    },
    {
      question: "What is the mode of examination for UPES Online students?",
      answer: "All assessments and examinations are conducted online through the university's secure LMS platform, ensuring flexibility and convenience for all learners.",
    },
  ];
  ...
  return (
    <>
      ...
      <Head>
        <title>UPES Online - Best BBA MBA BCA MCA Online Courses in India 2024 | UGC Approved</title>
        <meta name="description" content="UPES Online offers UGC-approved BBA, BCA, MBA, MCA online degree programs. Flexible learning, industry-aligned curriculum, career support & 25K+ students. NAAC A+ accredited. Enroll now!" />
        <meta name="keywords" content="UPES Online, BBA online, MBA online, BCA online, MCA online, online degree programs, UGC approved online courses, distance learning, online education India, best online universities" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="canonical" href="https://unifostedu.com/upes" />

        {/* Open Graph Tags */}
        <meta property="og:title" content="UPES Online - Best UGC Approved BBA MBA BCA MCA Courses" />
        <meta property="og:description" content="Explore UPES Online's UGC-entitled degree programs with flexible learning and career support. 25K+ students. Apply now!" />
        <meta property="og:image" content="https://res.cloudinary.com/didkrwhbu/image/upload/v1762327863/upes_uzkkmm.webp" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://unifostedu.com/upes" />

        {/* Twitter Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="UPES Online - Best UGC Approved Online Degree Programs" />
        <meta name="twitter:description" content="BBA, BCA, MBA, MCA online courses. Flexible learning for working professionals." />
        <meta name="twitter:image" content="https://res.cloudinary.com/didkrwhbu/image/upload/v1762327863/upes_uzkkmm.webp" />
      ...
      <div className="upes-font overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16 lg:h-20">
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                <a href="tel:+917042646766" className="hidden sm:flex items-center gap-2 text-gray-700 font-medium text-sm lg:text-base hover:text-orange-600 transition-colors">
                  <span className="text-lg">📞</span>
                  <span className="hidden lg:inline">+91 7042646766</span>
                  <span className="lg:hidden">Call Now</span>
                </a>

                <a href="tel:+917042646766" className="sm:hidden flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full text-orange-600 hover:bg-orange-200 transition-colors">
                  📞
                </a>

                <button
                  onClick={() => setOpenModal({ type: 'apply' })}
                  className="bg-[#d9235c] hover:bg-black text-white font-semibold px-3 py-2 sm:px-4 sm:py-2 lg:px-6 lg:py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg text-sm sm:text-base cursor-pointer"
                  aria-label="Apply Now for UPES Online"
                >
        ...
        <section id='Home' className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden" aria-label="UPES Online Courses Showcase">
          <AnimatePresence initial={false}>
            ...
            >
              <Image
                ...
                alt={`UPES University Online - Slide ${currentSlide + 1}`}
                width={1900}
                height={600}
        ...
        {/* About Section */}
        <HeroSection
          universityName="About UPES University Online"
          ...
          description2={`Recognized for its industry-aligned curriculum, UPES provides students with cutting-edge knowledge and skills to excel in their careers. The university is known for its strong industry connections and focus on innovation. With online and flexible learning, UPES is shaping the future of higher education in India.`}
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Explore undergraduate and postgraduate online degree programs. Experience quality, flexibility, and career-focused education from one of India's top universities in energy and technology domains.
              </p>
            </motion.div>
            ...
            <Tabs.Root value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="flex justify-center mb-8 sm:mb-12">
                <Tabs.List className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 bg-white/90 backdrop-blur-sm rounded-2xl p-2 shadow-xl border border-gray-200">
                  <Tabs.Trigger
                    value="all"
                    className={`px-4 py-2 sm:px-6 sm:py-3 rounded-xl text-sm sm:text-base font-semibold transition-all duration-300 ${activeTab === 'all' ? 'bg-gradient-to-r from-pink-500 to-red-500 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-red-100 hover:text-red-700'}`}
                  >
                    All Courses
                  </Tabs.Trigger>
                  <Tabs.Trigger
                    value="ug"
                    className={`px-4 py-2 sm:px-6 sm:py-3 rounded-xl text-sm sm:text-base font-semibold transition-all duration-300 ${activeTab === 'ug' ? 'bg-gradient-to-r from-pink-500 to-red-500 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-red-100 hover:text-red-700'}`}
                  >
                    Undergraduate
                  </Tabs.Trigger>
                  <Tabs.Trigger
                    value="pg"
                    className={`px-4 py-2 sm:px-6 sm:py-3 rounded-xl text-sm sm:text-base font-semibold transition-all duration-300 ${activeTab === 'pg' ? 'bg-gradient-to-r from-pink-500 to-red-500 text-white shadow-lg' : 'bg-gray-100 text-gray-700 hover:bg-red-100 hover:text-red-700'}`}
                  >
                    Postgraduate
                  </Tabs.Trigger>
                </Tabs.List>
        ...
        <section className="py-12 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-blue-700 mb-8">
              Undergraduate (UG) Online Courses at UPES
            </h2>
            ...
            <h2 className="text-3xl font-bold text-center text-green-700 mb-8">
              Postgraduate (PG) Online Courses at UPES
            </h2>
        ...
        <div>
          <AccreditationSection
            ...
            benefits={[
              ...
              {
                title: "Career Services & Job Support",
            ...
            accreditations={[
              { src: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327862/ugc_e5udyp.webp", alt: "UGC Approval", name: "UGC Entitled" },
              { src: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327027/aicte_ipdzee.webp", alt: "AICTE Accreditation", name: "AICTE Approved" },
              { src: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327508/naac_sh5g6b.webp", alt: "NAAC A+ Rating", name: "NAAC A+" },
              { src: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327720/nirf_f5xen9.webp", alt: "NIRF Ranking", name: "NIRF Ranked" },
              { src: "https://res.cloudinary.com/didkrwhbu/image/upload/v1762327870/wes_zuxwfs.webp", alt: "WES Recognition", name: "WES Recognized" },
            ]}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              <h3 className="text-3xl md:text-4xl font-bold text-black mb-12 text-center">
                Easy 4-Step UPES Online Admission Process
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-10 relative">
                ...
                {[
                  ...
                  >
                    ...
                    <h4 className="text-lg md:text-xl font-bold text-black mb-2">{step.title}</h4>
        ...
        <section className="bg-gray-50 py-16 px-6 md:px-20" id="upes-admission">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-6">
              UPES Online Admission Process - Step by Step Guide
            </h2>
              ...
              {[
                {
                  ...
                  content: "Begin by filling out the online enquiry form on the UniFost website. A UniFost Counsellor will contact you to understand your course interest, background, and eligibility.",
                },
                {
                  number: 2,
                  title: "Counselling & Course Selection",
                  content: "Your counsellor will provide detailed information about UPES Online programs, eligibility criteria, and fee structure. They will help you choose the most suitable UG or PG program for your career goals.",
                },
                {
                  number: 3,
                  title: "Document Verification",
                  content: "Upload scanned copies of your academic documents and ID proof. The UniFost Counsellor verifies your details to confirm eligibility before proceeding to the next step.",
                },
                {
                  number: 4,
                  title: "Application Form Submission",
                  content: "Complete the UPES Online application form under the supervision of your counsellor. All details are reviewed carefully to ensure accuracy and avoid any processing delays.",
                },
                {
                  number: 5,
                  title: "Payment of Fees",
                  content: "Make a secure online payment for your selected course. Once the payment is successfully completed, you will receive a confirmation and fee receipt via email.",
                },
                {
                  number: 6,
                  title: "Admission Confirmation",
                  content: "After verification, you'll receive your official admission letter from UPES Online. Your UniFost Counsellor will then assist you with LMS login credentials, induction schedule, and onboarding support.",
                },
              ].map((item) => (
                <div key={item.number}>
        ...
        <section id='QuickComparison' className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12">
              <span className="text-[#821812]">Online vs Regular Degree</span> Comparison
            </h2>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-[#d9235c] text-white">
                    ...
                    <th className="p-4 text-center">UPES Online</th>
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-10">
            <div className="flex-1">
              <Image
                ...
                height={400}
                loading="lazy"
                src="https://res.cloudinary.com/didkrwhbu/image/upload/v1762327865/upes-certificate_fznbzc.webp"
                alt="UPES University Online Certificate"
            ...
            <div className="flex-1 text-white">
              ...
              <h3 className="text-xl font-semibold mb-2">Benefits of UPES Online Degree:</h3>
            ...
            <div className="space-y-4 sm:space-y-6">
              {faqData.map((faq, index) => (
                ...
                >
                  ...
                  {openIndex === index && (
                    <div className="px-6 py-5 sm:px-8 sm:py-6 text-gray-700 bg-white border-t border-gray-100">
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-gray-800">
                Our UPES Online Learners Work At
              </h2>
              <p className="text-xl text-gray-600 mt-2">
                Top hiring partners and placement opportunities
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={idx} className="bg-white shadow-md rounded-lg p-4 flex items-center justify-center hover:scale-105 transition-transform">
                  <Image width={100} height={100} loading="lazy" src={src} alt={`Company ${idx + 1}`} className="h-12 object-contain" />
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <ul className="space-y-3 text-sm">
                    {[
                      ...
                      { name: 'FAQs', href: '#Faq' },
                      { name: 'Comparison', href: '#QuickComparison' },
                    ].map((link, i) => (
                      <li key={i}>
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <a href="tel:+917042646766" className="text-sm">+91 7042646766</a>
                    </div>
                    <div className="flex items-center gap-3">
                      <span className="text-orange-400">✉️</span>
                      <a href="mailto:info@unifostedu.com" className="text-sm">info@unifostedu.com</a>
                    </div>
                  </div>

                  <Button
                    onClick={() => setOpenModal({ type: 'apply' })}
                    className="w-full bg-[#d9235c] hover:bg-[#821812] text-white font-bold px-6 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300"
                  >
                    Apply Now
                  </Button>
                </motion.div>
            ...
            >
              <h4 className="text-lg font-bold mb-6 text-white text-center">
                Popular Courses & Specializations at UPES Online
              </h4>

              <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
                {[
                  "BBA Operations - UPES Online", "BBA Finance - UPES Online", "BBA HR - UPES Online", "BBA Marketing - UPES Online",
                  "BCA Cloud - UPES Online", "BCA Cyber Security - UPES Online", "BCA Data Analytics - UPES Online",
                  "MBA Oil & Gas - UPES Online", "MBA Finance - UPES Online", "MBA Supply Chain - UPES Online", "MBA HR - UPES Online",
                  "MCA AI & ML - UPES Online", "MCA Cyber Security - UPES Online", "MCA Data Science - UPES Online"
                ].map((keyword, index) => (
                  <span
                    key={index}
                    onClick={() => setOpenModal({ type: 'apply' })}
                    className="bg-white/10 backdrop-blur-sm text-gray-300 px-3 py-2 rounded-full text-xs sm:text-sm hover:bg-[#d9235c] hover:text-white transition-all duration-300 cursor-pointer border border-white/20"
                  >
                    {keyword}
                  </span>
                ))}

            ...
            <div className="container mx-auto px-4">
              <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div>
                  ...
                  <div className="mt-6">
                    <h3 className="text-xl font-bold text-red-600 mb-3"> About Us – Chandigarh University Online(CU Online)</h3>
                    <p className="mt-3 text-gray-700">
            ...
            <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="pt-8">
                ...
                <div className="flex justify-center gap-4 mb-12 flex-wrap">
                  <button
                    className={`px-6 py-4 w-60  text-xl ${activeCategory === "PG"
                  ...
                  <button
                    className={`px-6 py-4 w-60 text-xl ${activeCategory === "UG"
                        ? "bg-[#e60000] text-white"
                        : "bg-gray-200 text-gray-700"
                      }`}
                    onClick={() => {
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600 z-10 shadow-lg">➡️</button>
                </div>
                <div className="text-center mt-8 sm:mt-12">
                  <button
                    onClick={() => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                <p className="text-xl text-gray-700">
                  Admissions are open for the upcoming session. Please Fill the Form.
                </p>
                <div className="text-center mt-8 sm:mt-12">
                  <button
                    onClick={() => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <p className="text-gray-700 text-center text-lg">
                  For detailed information about the upcoming session,
                </p>
                <div className="text-center mt-8 sm:mt-12">
                  <button
                    onClick={() => {

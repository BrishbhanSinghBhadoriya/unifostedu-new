...
import { FaBook, FaBookOpen, FaBriefcase, FaClipboardCheck, FaRobot, FaBuildingColumns , FaUserGroup, FaUserTie } from 'react-icons/fa6';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              {
                icon: <FaBuildingColumns  className="text-2xl" />,

...
const AdmissionFeesProcessSessions = ({ setOpenModal, openModal }: { setOpenModal: (state: OpenModalState) => void; openModal: OpenModalState }) => {
  return (
        ...
        <div className="space-y-6">
          <div className="flex gap-4 items-start bg-white rounded-xl p-5 border border-gray-200 hover:border-orange-300 transition-all duration-300">
            ...
            <div className="flex-1">
              <h4 className="font-bold text-lg text-gray-900 mb-2">Visit the  Website</h4>
              <p className="text-gray-600 mb-4">Access the  Manipal Online website and navigate to the admissions section.</p>
              <button 
                onClick={() => setOpenModal({ type: 'apply' })}

...
const KeyHighlights = ({ setOpenModal, openModal }: { setOpenModal: (state: OpenModalState) => void; openModal: OpenModalState }) => {
  return (
    <section id="KeyHighlights" className="py-16 sm:py-20 bg-white" aria-labelledby="highlights-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 id="highlights-heading" className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border border-orange-200">
            <div className="w-12 h-12 bg-orange-500 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200">
            <div className="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
              <span className="text-white text-xl">💻</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
            <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
              <span className="text-white text-xl">🎯</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200">
            <div className="w-12 h-12 bg-purple-500 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
              <span className="text-white text-xl">👨‍🏫</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-6 border border-yellow-200">
            <div className="w-12 h-12 bg-yellow-500 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
              <span className="text-white text-xl">💼</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-6 border border-red-200">
            <div className="w-12 h-12 bg-red-500 rounded-lg flex items-center justify-center mb-4" aria-hidden="true">
              <span className="text-white text-xl">🌐</span>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              aria-label="Apply now for Manipal University online admission"
            ...
            <button
              ...
              aria-label="Download Manipal University brochure"

export const metadata = {
  ...
  keywords: "Manipal University Online, BBA Online, BCA Online, MBA Online, MCA Online, M.Com Online, MA Online, NAAC A++ University, Online Degree Programs India, Online Courses, Distance Learning",
  openGraph: {
    title: "Manipal University Online - UG & PG Courses in India",

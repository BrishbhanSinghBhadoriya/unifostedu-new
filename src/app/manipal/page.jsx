          ...
          <div className="absolute bottom-2 sm:bottom-4 md:bottom-8 left-1/2 transform -translate-x-1/2 z-20 w-full px-3 sm:px-4">
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                <img src="/images/naac.webp" alt="NAAC A+ Accredited" className="h-10 sm:h-12 md:h-16 w-10 sm:w-12 md:w-16 object-contain mb-1 sm:mb-2" />
                <p className="text-[10px] sm:text-xs md:text-sm font-bold text-gray-800">NAAC A+</p>
              </div>

              {/* Card 2 */}
              <div className="flex flex-col items-center text-center">
                <img src="/images/ugc.webp" alt="UGC Approved" className="h-10 sm:h-12 md:h-16 w-10 sm:w-12 md:w-16 object-contain mb-1 sm:mb-2" />
                <p className="text-[10px] sm:text-xs md:text-sm font-bold text-gray-800">UGC Approved</p>
              </div>

              {/* Card 3 */}
              <div className="flex flex-col items-center text-center">
                <img src="/images/qs.webp" alt="Global Recognition" className="h-10 sm:h-12 md:h-16 w-10 sm:w-12 md:w-16 object-contain mb-1 sm:mb-2" />
                <p className="text-[10px] sm:text-xs md:text-sm font-bold text-gray-800">Global Recognition</p>
              </div>
            </motion.div>
          </div>

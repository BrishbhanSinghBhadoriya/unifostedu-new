...
//   const navigate = useNavigate();
  const university = "Sharda University";
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden flex flex-col hover:shadow-xl transition duration-300">
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="mt-4">
          <button
            onClick={handleClick}
            className="bg-gradient-to-r from-blue-600 to-sky-400 text-white px-4 py-2 rounded-full text-center block font-semibold hover:opacity-90 transition w-full"
          >
            Enquire Now
          </button>
        </div>

...
type UniversityDetailsModalProps = {
  university: any;
  isOpen: boolean;
  onClose: () => void;
  courseTitle: string;
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-2/3 space-y-4">
              <div className="flex items-center text-gray-600">
                <FaLocationDot className="w-5 h-5 mr-3 text-[#00ffe0]" />
              ...
              <div className="flex items-center text-gray-600">
                <FaCircleCheck className="w-5 h-5 mr-3 text-[#00ffe0]" />
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {(Array.isArray(university.specializations) ? university.specializations : [university.specializations]).map((spec: string, index:  number) => (
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {university.features.map((feature: string, index:number) => (
                <div key={index} className="flex items-center">
                  <FaCircleCheck className="w-4 h-4 text-[#00ffe0] mr-3" />

...
const courses = [
  { title: "MBA Online", desc: "Gain strategic skills from top universities", tag: "Popular", icon: FaGraduationCap, duration: "2 Years", students: "10K+", color: "from-blue-500 to-purple-600" },
  { title: "MCA Online", desc: "Advance in tech with flexible learning", tag: "Top Rated", icon: FaBook, duration: "3 Years", students: "8K+", color: "from-green-500 to-teal-600" },
  { title: "M.Com Online", desc: "Deepen commerce expertise", tag: "Best Value", icon: FaBriefcase, duration: "2 Years", students: "6K+", color: "from-orange-500 to-red-600" },
  { title: "MA Online", desc: "Explore diverse specializations", tag: "Literature", icon: FaBookOpen, duration: "2 Years", students: "5K+", color: "from-purple-500 to-pink-600" },
  { title: "MAJMC Online", desc: "Master journalism and mass communication", tag: "Media", icon: FaGlobe, duration: "2 Years", students: "4K+", color: "from-indigo-500 to-blue-600" },
  { title: "BBA Online", desc: "Management fundamentals for the digital age", tag: "Career Starter", icon: FaUsers, duration: "3 Years", students: "15K+", color: "from-emerald-500 to-green-600" },
  { title: "BCA Online", desc: "Build a career in software development", tag: "Trending", icon: FaBook, duration: "3 Years", students: "12K+", color: "from-cyan-500 to-blue-600" },
  { title: "B.Com Online", desc: "Commerce education for business world", tag: "Business", icon: FaBriefcase, duration: "3 Years", students: "18K+", color: "from-amber-500 to-orange-600" },
  { title: "BA Online", desc: "Liberal arts foundation for diverse careers", tag: "Arts", icon: FaBookOpen, duration: "3 Years", students: "9K+", color: "from-rose-500 to-pink-600" },
  { title: "BAJMC Online", desc: "Journalism and mass communication basics", tag: "Media", icon: FaGlobe, duration: "3 Years", students: "7K+", color: "from-violet-500 to-purple-600" }
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section className="relative text-white overflow-hidden">
        <div className="relative w-full">
          {/* Slides */}
          <div className="relative h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] bg-gradient-to-br from-[#001e3c] to-[#003b6c]">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <button 
                    ...
                    className="bg-gradient-to-r from-[#00ffe0] to-[#00d4c4] text-[#001e3c] px-6 py-3 rounded-full text-base font-bold hover:from-[#00d4c4] hover:to-[#00ffe0] transform hover:scale-105 transition-all duration-300 shadow-xl shadow-[#00ffe0]/40 flex items-center justify-center gap-2"
                  >
                    <FaRocket className="text-lg" />
                    Get Started Today
                  </button>
                    <button className="border-2 border-white text-white px-6 py-3 rounded-full text-base font-bold bg-white/10 hover:bg-white hover:text-[#001e3c] transform hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-xl p-8 hover:transform hover:-translate-y-2 transition-all duration-300 border border-gray-100 group-hover:shadow-2xl">
                  ...
                  <h3 className="text-xl font-bold text-[#001e3c] mb-4">{feature.title}</h3>
            ...
            {colleges.map((college, index) => (
              ...
              >
                <div className="bg-white rounded-2xl shadow-xl p-6 hover:transform hover:-translate-y-2 transition-all duration-300 border border-gray-100 group-hover:shadow-2xl">
                  ...
                  <button className="w-full bg-gradient-to-r from-[#001e3c] to-[#003b6c] text-white py-2 px-4 rounded-xl font-medium hover:from-[#003b6c] hover:to-[#001e3c] transform hover:scale-105 transition-all duration-300">
                    Learn More
                  </button>
                </div>
              </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Students from across India trust Unifost for their education
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {cities.map((city, index) => (
              <motion.div
                ...
                data-aos-delay={index * 100}
              >
                <div className="bg-white rounded-2xl shadow-xl p-6 hover:transform hover:-translate-y-2 transition-all duration-300 border border-gray-100 group-hover:shadow-2xl text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#00ffe0] to-[#00d4c4] p-1">
                    <img src={city.img} alt={city.city} className="w-full h-full rounded-full object-cover" />
                  </div>
                  <h3 className="text-lg font-bold text-[#001e3c] mb-1">{city.city}</h3>
                  <p className="text-sm text-gray-600 mb-2">{city.state}</p>
                  <div className="text-sm text-[#00ffe0] font-medium">{city.students} Students</div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      {showEnquiryModal && (
        <Dialog open={showEnquiryModal} onOpenChange={setShowEnquiryModal}>
          <DialogContent className="max-w-2xl">
            ...
            <EnquiryForm onClose={() => setShowEnquiryModal(false)} />
          </DialogContent>
        </Dialog>
      )}
    </div>

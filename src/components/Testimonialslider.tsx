...
const students = [
  ...
  { id: 20, name: "Pallavi Dubey",    gender:"F", university: "LPU Online",               program: "M.Sc Psychology",         type: "PG", image: F("PallaviDubey"),    quote: "Choosing the right postgraduate program was overwhelming, but Unifost Edu. Pvt. Ltd. made it simple and confident. They matched my interest in psychology with Symbiosis Online's excellent M.Sc program. The entire journey with Unifost has been smooth, transparent, and incredibly fulfilling. Thank you Unifost team!" },
];
